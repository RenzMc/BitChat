package com.renchat.android.crypto

import android.content.Context
import android.util.Log
import com.renchat.android.noise.NoiseEncryptionService
 ...
 * 
 * This is the main interface for all encryption/decryption operations in RenChat.
...
class EncryptionService(private val context: Context) {
    ...
    fun clearPersistentIdentity() {
        ...
        try {
            val prefs = context.getSharedPreferences("RenChat_crypto", Context.MODE_PRIVATE)

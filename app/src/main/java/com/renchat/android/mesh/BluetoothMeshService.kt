package com.renchat.android.mesh
...
class BluetoothMeshService(private val context: Context) {
    ...
    private fun setupDelegates() {
        ...
        storeForwardManager.delegate = object : StoreForwardManagerDelegate {
            ...
            override fun sendPacket(packet: RenChatPacket) {
        ...
        messageHandler.delegate = object : MessageHandlerDelegate {
            ...
            override fun verifySignature(packet: RenChatPacket, peerID: String): Boolean {
            ...
            // Callbacks
            override fun onMessageReceived(message: RenChatMessage) {
        ...
        packetProcessor.delegate = object : PacketProcessorDelegate {
            override fun validatePacketSecurity(packet: RenChatPacket, peerID: String): Boolean {
            ...
            override fun handleFragment(packet: RenChatPacket): RenChatPacket? {
        ...
        connectionManager.delegate = object : BluetoothConnectionManagerDelegate {
            override fun onPacketReceived(packet: RenChatPacket, peerID: String, device: android.bluetooth.BluetoothDevice?) {
        ...
        serviceScope.launch {
            ...
            if (encryptionService.hasEstablishedSession(recipientPeerID)) {
                try {
                    ...
                    val privateMessage = com.renchat.android.model.PrivateMessagePacket(
                    ...
                    val messagePayload = com.renchat.android.model.NoisePayload(
                        type = com.renchat.android.model.NoisePayloadType.PRIVATE_MESSAGE,
                        data = tlvData
                    )
    ...
    fun sendReadReceipt(messageID: String, recipientPeerID: String, readerNickname: String) {
        serviceScope.launch {
            ...
            try {
                ...
                val readReceiptPayload = com.renchat.android.model.NoisePayload(
                    type = com.renchat.android.model.NoisePayloadType.READ_RECEIPT,
     ...
     */
    fun getSessionState(peerID: String): com.renchat.android.noise.NoiseSession.NoiseSessionState {
...
interface BluetoothMeshDelegate {
    fun didReceiveMessage(message: RenChatMessage)

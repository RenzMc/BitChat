...
class FragmentManager {
     ...
     */
    fun createFragments(packet: RenChatPacket): List<RenChatPacket> {
        ...
        val fragments = mutableListOf<RenChatPacket>()
     ...
     */
    fun handleFragment(packet: RenChatPacket): RenChatPacket? {
        ...
        try {
            ...
            if (fragmentMap != null && fragmentMap.size == fragmentPayload.total) {
                ...
                val originalPacket = RenChatPacket.fromBinaryData(reassembledData.toByteArray())
...
interface FragmentManagerDelegate {
    fun onPacketReassembled(packet: RenChatPacket)
}

...
class BluetoothConnectionManager(
    ...
    private val componentDelegate = object : BluetoothConnectionManagerDelegate {
        override fun onPacketReceived(packet: RenChatPacket, peerID: String, device: BluetoothDevice?) {
...
interface BluetoothConnectionManagerDelegate {
    fun onPacketReceived(packet: RenChatPacket, peerID: String, device: BluetoothDevice?)

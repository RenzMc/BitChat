 ...
 * 
 * This class handles all relay decisions and logic for RenChat packets.
...
class PacketRelayManager(private val myPeerID: String) {
     ...
     */
    internal fun isPacketAddressedToMe(packet: RenChatPacket): Boolean {
     ...
     */
    private fun shouldRelayPacket(packet: RenChatPacket, fromPeerID: String): Boolean {

//package com.renchat.android.services
//
...
//
//    suspend fun saveMessage(message: RenChatMessage, forChannel: String) = withContext(Dispatchers.IO) {
...
//    }
//
//    suspend fun loadMessagesForChannel(channel: String): List<RenChatMessage> = withContext(Dispatchers.IO) {
...
//    }
//
//    private fun loadMessagesFromFile(file: File): List<RenChatMessage> {
//        if (!file.exists()) {
//            return emptyList()
//        }
//
...
//                    ois.readObject() as List<RenChatMessage>
//                }
//            }
//        } catch (e: Exception) {
...
//    }
//
//    private fun saveMessagesToFile(file: File, messages: List<RenChatMessage>) {

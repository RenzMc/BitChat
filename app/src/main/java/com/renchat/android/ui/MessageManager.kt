...
class MessageManager(private val state: ChatState) {
    ...
    fun addMessage(message: RenChatMessage) {
    ...
    fun addChannelMessage(channel: String, message: RenChatMessage) {
    ...
    fun addPrivateMessage(peerID: String, message: RenChatMessage) {
     ...
     */
    fun generateMessageKey(message: RenChatMessage): String {

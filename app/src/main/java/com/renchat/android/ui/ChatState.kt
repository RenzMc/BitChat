...
class ChatState {
    ...
    // Private chats
    private val _privateChats = MutableLiveData<Map<String, List<RenChatMessage>>>(emptyMap())
    val privateChats: LiveData<Map<String, List<RenChatMessage>>> = _privateChats
    ...
    private val _channelMessages = MutableLiveData<Map<String, List<RenChatMessage>>>(emptyMap())
    val channelMessages: LiveData<Map<String, List<RenChatMessage>>> = _channelMessages
    ...
    private val _viewedMessages = MutableLiveData<Set<String>>(emptySet())
    val viewedMessages: LiveData<Set<String>> = _viewedMessages
    ...
    private val _selectedLocationChannel = MutableLiveData<com.renchat.android.geohash.ChannelID?>(com.renchat.android.geohash.ChannelID.Mesh)
    val selectedLocationChannel: LiveData<com.renchat.android.geohash.ChannelID?> = _selectedLocationChannel
    ...
    fun getViewedMessagesValue() = _viewedMessages.value ?: emptySet()
    ...
    fun setPrivateChats(chats: Map<String, List<RenChatMessage>>) {
    ...
    fun setChannelMessages(messages: Map<String, List<RenChatMessage>>) {
    ...
    fun setViewedMessages(viewed: Set<String>) {
        _viewedMessages.value = viewed
    }
    
    fun addViewedMessage(messageId: String) {
        val currentViewed = _viewedMessages.value ?: emptySet()
        _viewedMessages.value = currentViewed + messageId
    }
    
    fun setSelectedLocationChannel(channel: com.renchat.android.geohash.ChannelID?) {

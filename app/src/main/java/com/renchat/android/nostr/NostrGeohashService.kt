...
class NostrGeohashService(
    ...
    private val dataManager: com.renchat.android.ui.DataManager,
    private val notificationManager: com.renchat.android.ui.NotificationManager
) {
    ...
    companion object {
        ...
        fun initialize(
            ...
            dataManager: com.renchat.android.ui.DataManager,
            notificationManager: com.renchat.android.ui.NotificationManager
        ): NostrGeohashService {
    ...
    private var locationChannelManager: com.renchat.android.geohash.LocationChannelManager? = null
    ...
    fun initializeLocationChannelState() {
        try {
            ...
            locationChannelManager = com.renchat.android.geohash.LocationChannelManager.getInstance(application)
            ...
            state.setSelectedLocationChannel(com.renchat.android.geohash.ChannelID.Mesh)
     ...
     */
    fun sendGeohashMessage(content: String, channel: com.renchat.android.geohash.GeohashChannel, myPeerID: String, nickname: String?) {
        coroutineScope.launch {
            try {
    ...
    private fun handleNostrMessage(giftWrap: NostrEventRelay) {
        ...
        try {
            ...
            if (packet.type != com.renchat.android.protocol.MessageType.NOISE_ENCRYPTED.value) {
            ...
            val noisePayload = com.renchat.android.model.NoisePayload.decode(packet.payload)
    ...
    private fun processNoisePayload(
        noisePayload: com.renchat.android.model.NoisePayload,
        targetPeerID: String,
        senderNickname: String,
        messageTimestamp: Date
    ) {
        when (noisePayload.type) {
            com.renchat.android.model.NoisePayloadType.PRIVATE_MESSAGE -> {
                val pm = com.renchat.android.model.PrivateMessagePacket.decode(noisePayload.data)
                if (pm == null) {
                ...
                val message = RenChatMessage(
                    ...
                    deliveryStatus = com.renchat.android.model.DeliveryStatus.Delivered(
            ...
            com.renchat.android.model.NoisePayloadType.DELIVERED -> {
            ...
            com.renchat.android.model.NoisePayloadType.READ_RECEIPT -> {
                val messageId = String(noisePayload.data, Charsets.UTF_8)
    ...
    private fun findNoiseKeyForNostrPubkey(nostrPubkey: String): ByteArray? {
        return com.renchat.android.favorites.FavoritesPersistenceService.shared.findNoiseKey(nostrPubkey)
    }
    ...
    private fun getFavoriteNickname(noiseKey: ByteArray): String? {
        return com.renchat.android.favorites.FavoritesPersistenceService.shared.getFavoriteStatus(noiseKey)?.peerNickname
    }
     ...
     */
    private fun switchLocationChannel(channel: com.renchat.android.geohash.ChannelID?) {
        ...
        coroutineScope.launch {
            try {
                ...
                if (channel is com.renchat.android.geohash.ChannelID.Location) {
    ...
    private fun handleUnifiedGeohashEvent(event: NostrEvent, geohash: String) {
        try {
            ...
            val shouldShowMessage = currentGeohash == geohash || 
                (selectedLocationChannel is com.renchat.android.geohash.ChannelID.Location && 
    ...
    private fun handleGeohashDmEvent(
        ...
        try {
            ...
            val noisePayload = com.renchat.android.model.NoisePayload.decode(packet.payload) ?: return
            val messageTimestamp = Date(rumorTimestamp * 1000L)
            ...
            when (noisePayload.type) {
                com.renchat.android.model.NoisePayloadType.PRIVATE_MESSAGE -> {
                    val pm = com.renchat.android.model.PrivateMessagePacket.decode(noisePayload.data) ?: return
                    val messageId = pm.messageID
    ...
    fun sendNostrGeohashDM(content: String, recipientPeerID: String, messageID: String, myPeerID: String) {
        coroutineScope.launch {
            try {
                ...
                val locationChannelManager = com.renchat.android.geohash.LocationChannelManager.getInstance(application)
                val selectedChannel = locationChannelManager.selectedChannel.value
                
                if (selectedChannel !is com.renchat.android.geohash.ChannelID.Location) {

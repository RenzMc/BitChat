...
import com.renchat.android.model.ReadReceipt
...
class NostrTransport(
    ...
    private fun resolveNostrPublicKey(peerID: String): String? {
        try {
            ...
            val favoriteStatus = com.renchat.android.favorites.FavoritesPersistenceService.shared.getFavoriteStatus(noiseKey)
            ...
            if (peerID.length == 16) {
                val fallbackStatus = com.renchat.android.favorites.FavoritesPersistenceService.shared.getFavoriteStatus(peerID)

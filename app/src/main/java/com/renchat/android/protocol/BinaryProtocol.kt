...
data class RenChatPacket(
    ...
    fun toBinaryDataForSigning(): ByteArray? {
        ...
        val unsignedPacket = RenChatPacket(
            version = version,
            type = type,
            senderID = senderID,
    ...
    companion object {
        fun fromBinaryData(data: ByteArray): RenChatPacket? {
...
object BinaryProtocol {
    ...
    fun encode(packet: RenChatPacket): ByteArray? {
        try {
    ...
    fun decode(data: ByteArray): RenChatPacket? {
     ...
     */
    private fun decodeCore(raw: ByteArray): RenChatPacket? {
        try {

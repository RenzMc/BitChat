package com.renchat.android.noise

import android.content.Context
import android.util.Log
import com.renchat.android.identity.SecureIdentityStateManager
import com.renchat.android.mesh.PeerFingerprintManager
import com.renchat.android.noise.southernstorm.protocol.Noise
...
class NoiseEncryptionService(private val context: Context) {
    ...
    private fun generateKeyPair(): Pair<ByteArray, ByteArray> {
        try {
            val dhState = com.renchat.android.noise.southernstorm.protocol.Noise.createDH("25519")
    ...
    /**
     * Sign a RenChatPacket using our Ed25519 signing key
     */
    fun signPacket(packet: com.renchat.android.protocol.RenChatPacket): com.renchat.android.protocol.RenChatPacket? {
    ...
    /**
     * Verify a RenChatPacket signature using the provided public key
     */
    fun verifyPacketSignature(packet: com.renchat.android.protocol.RenChatPacket, publicKey: ByteArray): Boolean {
